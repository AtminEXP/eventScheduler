 ...
 * @class
 */
var VCardTime = /*#__PURE__*/function (_Time2) {
  /**
  ...
  function VCardTime(data, zone, icaltype) {
    ...
    _this2 = _callSuper(this, VCardTime, [data, zone]);
    /**
     * The class identifier.
     * @constant
     * @type {String}
     * @default "vcardtime"
     */
    _defineProperty(_this2, "icalclass", "vcardtime");
    /**
     * The type name, to be used in the jCal object.
     * @type {String}
     * @default "date-and-or-time"
     */
    _defineProperty(_this2, "icaltype", "date-and-or-time");
    _this2.icaltype = icaltype || "date-and-or-time";
    return _this2;
  }
  _inherits(VCardTime, _Time2);
